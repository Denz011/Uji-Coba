...
handler.all = async function (m) {
	...
	try {
		...
		global.kontak2 = [
         [owner[0], await conn.getName(owner[0] + '@s.whatsapp.net'), ' ', 'kawantuman@gmail.com', true],
         [owner[1], await conn.getName(owner[1] + '@s.whatsapp.net'), ' ', 'kawantuman@gmail.com', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
...
global.fakefb = {
        ...
        global.fvn = {
            ...
            { remoteJid: "62856070692863-1625305606@g.us" } : {}) 
                       },
            message: { 
               "audioMessage": {
       ...
       key: {
           ...
           "message": {
               "groupInviteMessage": {
                   "groupJid": "62856070692863-1625305606@g.us",
                   "inviteCode": "null",
                   "groupName": "Tes Bot", 
                   "caption": wm, 
                   'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')
